...
/**
 * Generated class for the TeliForoiKaiAllesAdeiesPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-teli-foroi-kai-alles-adeies',
  templateUrl: 'teli-foroi-kai-alles-adeies.html',
})
export class TeliForoiKaiAllesAdeiesPage {
  params: any;
  dataset: any;
